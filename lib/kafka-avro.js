...
var rootLog = require('./log.lib').getChild(__filename);
...
KafkaAvro.prototype.init = Promise.method(function () {
  this.log.info('init() :: Initializing KafkaAvro...');
  return this.sr.init();
});
...
KafkaAvro.prototype.dispose = Promise.method(function () {
  ...
  this.log.info('dispose() :: Disposing kafka-avro instance. Total consumers:',
